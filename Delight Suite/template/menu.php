...
if (!isset($_SESSION)){
    session_start();
    $_SESSION["URL"] = "http://localhost:8082/ProyectoDB/trunk/Delight%20Suite/";
}
?>
<!DOCTYPE html>
<html lang="en">
...
<body>
  <nav class="navbar sticky-top navbar-expand-lg navbar-toggleable-sm navbar-dark" style="background-color: black">
    <a class="navbar-brand" style="font-size: 40px; font-family: Monotype Corsiva" href="<?php echo $_SESSION["URL"];?>">
    ...
    <div class="collapse navbar-collapse" id="navbarNavDropdown" style="font-size: 18px; font-family: Georgia; color: #FFFFFF;">
      <ul class="navbar-nav mr-auto ml-auto text-center" style="">
        <li class="nav-item">
          <a class="nav-link" href="<?php echo $_SESSION["URL"];?>">Inicio <i class="fa fa-home" aria-hidden="true"></i></a>
        </li>
        <li class="nav-item dropdown">
          ...
          <div class="dropdown-menu text-center" aria-labelledby="navbarDropdownMenuLink" style="background-color: black;">
            <a class="dropdown-item" href="<?php echo $_SESSION["URL"];?>Catalogo/catalogo_habitaciones.php" style="color: gray">Catalogo de Habitaciones</a>
            <a class="dropdown-item" href="<?php echo $_SESSION["URL"];?>Catalogo/catalogo_productos.php" style="color: gray">Catalogo de Productos</a>
